    ...
    <section className="py-12 px-4 md:px-8" id="booking">
      <Container>
        <div className="max-w-7xl mx-auto rounded-4xl md:rounded-[3rem] bg-primary p-4 md:p-16 text-center text-surface-container-lowest relative overflow-hidden">
          ...
          <h2 className="text-xl md:text-5xl font-extrabold mb-6 relative z-10">
            Siap Main Game Sekarang?
          </h2>

          <p className="text-primary-fixed text-sm md:text-lg mb-10 max-w-xl mx-auto relative z-10">
          ...
          <Link
            href="/booking"
            className="relative z-10 inline-flex items-center justify-center gap-3 mx-auto bg-secondary-container text-secondary-on-container px-5 md:px-12 py-4 md:py-5 rounded-xl font-extrabold text-lg md:text-xl shadow-ambient-blue hover:scale-105 transition-transform"
          >
            Booking Online
