  ...
  if (!shouldAnimate) {
    return (
      <section className="py-5 md:py-12 h-screen bg-primary-fixed/20">
        <Container>
          <div className="flex flex-col-reverse md:flex-row gap-5 md:gap-10 items-center">
            <div className="text-center md:text-left max-w-147]">
              ...
              <div className="flex gap-3 flex-col sm:flex-row">
                <a
                  href="booking"
                  className="inline-flex items-center justify-center px-6 py-3 bg-secondary-container text-on-secondary-container rounded-xl font-bold hover:scale-105 transition-transform duration-300"
                >
                  Booking Sekarang
                </a>
              </div>
  ...
  return (
    <section className="py-5 md:py-12 h-screen bg-primary-fixed/20">
      <Container>
        <div className="flex flex-col-reverse md:flex-row gap-5 md:gap-10 items-center">
          <div className="text-center md:text-left max-w-147]">
            <FadeInUp delay={0} duration={duration}>
              <span className="hidden md:inline-block px-3 py-1 rounded-full bg-primary-container text-on-primary text-xs font-bold uppercase tracking-widest mb-4">
                Premium Home Service
              </span>
            </FadeInUp>
            ...
            <FadeInUp delay={0.2} duration={duration}>
              <p className="text-sm md:text-base text-on-surface-variant mb-6 max-w-lg">
                Nikmati pengalaman gaming konsol premium tanpa ribet. Gratis
                ongkir hingga 7km dari Base Station kami.
              </p>
            </FadeInUp>
            <FadeInUp delay={0.3} duration={duration}>
              <div className="flex gap-3 flex-col sm:flex-row">
                <a
                  href="booking"
                  className="inline-flex items-center justify-center px-6 py-3 bg-secondary-container text-on-secondary-container rounded-xl font-bold hover:scale-105 transition-transform duration-300"
          ...
          <HoverScale scale={1.05} className="relative">
